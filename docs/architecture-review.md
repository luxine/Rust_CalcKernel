...
| C backend | `src/backend/mod.rs`, C emission sections | C/header output parity, dijkstra C dynamic-library runtime parity, f64-array C dynamic-library runtime parity, f64-axpy/f64-sum/pricing-SoA C dynamic-library runtime parity, f64 edge fixture C dynamic-library runtime parity, C dynamic-library runtime parity, checked/unchecked ABI checks |
