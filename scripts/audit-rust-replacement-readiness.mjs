...
expectIncludes(readme, "npm run verify:declaration-parity", "README local gate");
expectIncludes(readme, "npm run verify:public-api-parity", "README local gate");
expectIncludes(readme, "npm run audit:release-workflow", "README local gate");
expectIncludes(readme, "node scripts/audit-rust-replacement-readiness.mjs", "README local gate");
expectIncludes(zhReadme, "npm run verify:declaration-parity", "Chinese README local gate");
expectIncludes(zhReadme, "npm run verify:public-api-parity", "Chinese README local gate");
expectIncludes(zhReadme, "npm run audit:release-workflow", "Chinese README local gate");
expectIncludes(zhReadme, "node scripts/audit-rust-replacement-readiness.mjs", "Chinese README local gate");
...
expectIncludes(npmRelease, "sourceRepository", "npm release docs");
expectIncludes(npmRelease, "githubRepository", "npm release docs");
...
expectIncludes(npmRelease, "release-manifest.json.sourceRepository", "npm release docs");
expectIncludes(npmRelease, "release-signoff.json.sourceRepository", "npm release docs");
expectIncludes(npmRelease, "release-signoff-summary.json.sourceRepository", "npm release docs");
expectIncludes(npmRelease, "signedTargets[].githubRepository", "npm release docs");
expectIncludes(npmRelease, "npm-publish-artifact.json.sourceRepository", "npm release docs");
expectIncludes(npmRelease, "npm-publish-result.json.sourceRepository", "npm release docs");
expectIncludes(npmRelease, "GITHUB_REPOSITORY", "npm release docs");
...
expectIncludes(npmRelease, "runtime object metadata surface", "npm release docs");
expectIncludes(npmRelease, "runtime object own property surface", "npm release docs");
