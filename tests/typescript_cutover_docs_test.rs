...
fn rust_replacement_readiness_audit_should_require_source_git_sha_evidence() {
    ...
    for expected in [
        ...
        r#"expectIncludes(npmRelease, "release-signoff.json.sourceRepository", "npm release docs")"#,
        r#"expectIncludes(npmRelease, "release-signoff-summary.json.sourceRepository", "npm release docs")"#,
        r#"expectIncludes(npmRelease, "signedTargets[].githubRepository", "npm release docs")"#,
...
fn rust_replacement_readiness_audit_should_require_public_api_parity_verifier() {
    ...
    for expected in [
        ...
        r#"expectIncludes(npmRelease, "runtime object metadata surface", "npm release docs")"#,
        r#"expectIncludes(npmRelease, "runtime object own property surface", "npm release docs")"#,
        ...
        r#"expectIncludes(npmRelease, "runtime class object metadata surface", "npm release docs")"#,
        r#"expectIncludes(npmRelease, "runtime class instance metadata surface", "npm release docs")"#,
        r#"expectIncludes(npmRelease, "runtime class instance own property surface", "npm release docs")"#,
        r#"expectIncludes(npmRelease, "runtime class instance property descriptor surface", "npm release docs")"#,
