...
| LLVM backend | `src/backend/mod.rs`, LLVM sections | LLVM IR parity, dijkstra LLVM object/dynamic runtime parity, object/dynamic-library runtime parity, target/clang behavior parity |
