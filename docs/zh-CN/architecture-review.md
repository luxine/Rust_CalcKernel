...
| C backend | `src/backend/mod.rs` 的 C emission 部分 | C/header 输出 parity、dijkstra C dynamic-library runtime parity、f64-array C dynamic-library runtime parity、f64-axpy/f64-sum/pricing-SoA C dynamic-library runtime parity、f64 edge fixture C dynamic-library runtime parity、C dynamic-library runtime parity、checked/unchecked ABI checks |
